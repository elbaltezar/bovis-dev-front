...
export const obtenerMeses = async (fechaInicio: Date, fechaFin: Date): Promise<Mes[]> => {
...
export const obtenerMesesFecha = async (fechaInicio: Date, fechaFin: Date): Promise<Mes[]> => {
 ...
 */
export const formatearInformacionControl = async (data: SeccionData | SeccionSubseccion): Promise<SeccionFormateada | null> => {
